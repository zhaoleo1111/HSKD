...
def get_tiny_dataloaders(batch_size=128, num_workers=8, is_instance=False):
    """
    stl10
    """
    data_dir = '/home/devuser/Downloads/data/tiny-imagenet-200/'
    ...
    dataset_val = TinyImageNet(data_dir, train=False,transform=test_transform)
