...
class CIFAR_ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        s_out1 = out
        out = self.layer2(out)  # 128
        s_out2 = out
        out = self.layer3(out)  # 256
        s_out3 = out
        out = self.layer4(out)  # 512
        s_out4 = out
...
def resnet50_dtskd(pretrained=False, **kwargs):
    return CIFAR_ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)

def resnet101_dtskd(pretrained=False, **kwargs):
    return CIFAR_ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)

def seresnet50_dtskd(pretrained=False, **kwargs):
    return CIFAR_ResNet(SEBottleneck, [3, 4, 6, 3], **kwargs)