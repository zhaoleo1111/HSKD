...
__all__ = ['MixSKD_CIFAR_ResNet18','MixSKD_CIFAR_ResNet50','MixSKD_CIFAR_ResNet101']
...
def MixSKD_CIFAR_ResNet101(**kwargs):
    return ResNet_Auxiliary(Bottleneck, [3,4,23,3], **kwargs)

def MixSKD_CIFAR_SeResNet50(pretrained=False, **kwargs):
